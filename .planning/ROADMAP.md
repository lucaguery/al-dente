...
**Plans:** 3 plans
Plans:
- [ ] 25-01-PLAN.md — Foundation: Alembic 0009 (table + column + DELETE failed + backfill + drop) + RecipeTurn ORM + Pydantic schemas + locked TurnSender/TurnKind vocabularies in both enum files (THREAD-01, THREAD-03, MIGRATION-01)
...
|-------|-----------|----------------|--------|-----------|
| 25. Backend foundation | v0.6 | 0/3 | Not started | - |
