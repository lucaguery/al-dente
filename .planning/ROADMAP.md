...
**Plans:** 6 plans
Plans:
- [ ] 29-01-PLAN.md — Wave 1 foundation: Alembic 0011 adds recipes.questions_deferred_until (timestamptz NULL); mirror on Recipe ORM + RecipeResponse + frontend Recipe type (D-21)
- [ ] 29-02-PLAN.md — Wave 1 foundation: NEW backend/app/services/completeness.py — Python parallel of recipe-completeness.ts (FIELD_KEYS, compute_completeness, is_field_filled, is_conflict, INPUT_TYPE_MAP, _FIELD_PROMPTS_FR, _FIELD_LABELS_FR, OPTIONS_MAP) + parity tests (D-15, D-10, D-14, D-06, D-16)
- [ ] 29-03-PLAN.md — Wave 1 foundation: Graduate SummaryTurnPayload (body, chips, extraction_hash) + QuestionTurnPayload (field, prompt, input_type, options, multi) from Phase 25 stubs (D-05, D-13)
...
| 29. LLM prompt rework + completeness wire-up | v0.6 | 0/6 | Planned     | - |
