...
**Success Criteria** (what must be TRUE):
  1. A user re-saving any recipe shipped under v0.5 still sees it intact after the migration runs — each recipe now carries one initial turn matching its legacy capture surface (`type='manual'→text` / `voice→voice` / `photo→photo` / `url→url`).
...
|-------|-----------|----------------|--------|-----------|
| 25. Backend foundation | v0.6 | 0/TBD | Not started | - |
