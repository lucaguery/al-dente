...
**Plans**: 2 plans
  - [x] 39-01-PLAN.md — Migration safety: throwaway-DB fixture + parametrized upgrade/downgrade test for all 11 Alembic revisions (MIG-01, MIG-02) — 10 passed, 1 xfailed (0006 intentional)
