# Requirements Archive: v0.6 Conversation Capture
...
|-------------|-------|--------|
| THREAD-01 | Phase 25 — Backend foundation | Complete |
| THREAD-02 | Phase 25 — Backend foundation | Complete |
| THREAD-03 | Phase 25 — Backend foundation | Complete |
| THREAD-04 | Phase 25 — Backend foundation | Complete |
| TURN-01 | Phase 26 — Thread API & realtime | Complete |
| TURN-02 | Phase 26 — Thread API & realtime | Complete |
| TURN-03 | Phase 26 — Thread API & realtime | Complete |
| TURN-04 | Phase 26 — Thread API & realtime | Complete |
| CAPTURE-01 | Phase 27 — Conversational capture screen | Complete |
| CAPTURE-02 | Phase 27 — Conversational capture screen | Complete |
| CAPTURE-03 | Phase 27 — Conversational capture screen | Complete |
| CAPTURE-04 | Phase 27 — Conversational capture screen | Complete |
| DETAIL-01 | Phase 28 — Recipe-detail thread | Complete |
| DETAIL-02 | Phase 28 — Recipe-detail thread | Complete |
| DETAIL-03 | Phase 28 — Recipe-detail thread | Complete |
| DETAIL-04 | Phase 28 — Recipe-detail thread | Complete |
| DETAIL-05 | Phase 28 — Recipe-detail thread | Complete |
| LLM-01 | Phase 29 — LLM prompt rework + completeness wire-up | Complete |
| LLM-02 | Phase 29 — LLM prompt rework + completeness wire-up | Complete |
| LLM-03 | Phase 29 — LLM prompt rework + completeness wire-up | Complete |
| LLM-04 | Phase 29 — LLM prompt rework + completeness wire-up | Complete |
| MIGRATION-01 | Phase 25 — Backend foundation | Complete |
