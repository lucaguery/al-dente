...
from app.routers import pings, ws
...
app.include_router(pings.router)  # plan 01-05 (deleted in 01-12 per D-01)
app.include_router(ws.router)  # plan 01-05 — uses @router.websocket("/ws")
# plan 01-04 (households router) is added by the parallel onboarding-backend
# worktree and merged in by the orchestrator. plan 01-08 adds recipes.router.
